...
We keep your data while your account is active. Deleting your account (Settings → Delete account) permanently removes your account and its data from our systems; Settings → Reset clears specific content without deleting the account. Some records — like purchase receipts — may be kept longer where Apple, Google, or the law requires it.
...
Wherever you live, you can use the tools above (export, delete, reset, correct) or email **privacy@skeined.com** and we'll help. Depending on where you are, you may also have specific legal rights:

- **South Africa (POPIA).** MalHQ is the responsible party for your information. You may access or correct it, object to its processing, or lodge a complaint with the Information Regulator.
- **EU / UK (GDPR).** You have rights of access, correction, erasure, portability, and objection. We process your data to provide the app (our contract with you), with your consent (e.g. push notifications), and for our legitimate interest in keeping Skeined working and secure.
- **California (CCPA/CPRA).** You have rights to know, delete, and correct your information. We do **not** sell or "share" personal information, and never have.
...
You must be at least 13 years old (or the minimum age of digital consent where you live, if that's higher) to use Skeined. You're responsible for the accuracy of your account information and for keeping your credentials secure. One account per person. You can use core features anonymously before creating a full account; some features require a signed-in account.
...
You keep ownership of the patterns, designs, and notes you create or import into Skeined. You're responsible for having the right to use any pattern you import — Skeined is a tool for working with patterns you're entitled to use, not a claim over pattern designers' own copyright. You agree not to import or share content you don't have the right to use, and you're responsible for any claim that arises from content you bring into Skeined.
...
Skeined is provided "as is." We work hard to make it reliable, but we don't guarantee it will be error-free or uninterrupted. To the extent permitted by law, MalHQ isn't liable for indirect damages arising from your use of the app, including craft outcomes, and our total liability for any claim relating to Skeined is limited to what you paid us for it in the 12 months before the claim. Some places don't allow certain limits, so parts of this may not apply to you.

## Governing law

These terms are governed by the laws of South Africa. Nothing here removes mandatory consumer protections you're entitled to under the laws of the country where you live — where those apply, they take precedence over anything inconsistent in these terms.
